            ...
            <div class="title_left">
                <div class="wrap-breadcrumb">
                    <ul>
                        ...
                        <li class="item-link"><a href="{{route('testimonial.index')}}"
                                class="link">Testimonial</a>
                        </li>
                        <li class="item-link"><a href="{{route('testimonial.create')}}"
                                class="link">Create</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" action="{{route('testimonial.store')}}" method="POST"
