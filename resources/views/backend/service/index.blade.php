            ...
            <div class="title_left">
                <div class="wrap-breadcrumb">
                    <ul>
                        ...
                        <li class="item-link"><a href="{{route('service.index')}}" class="link">Service</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                                ...
                                <tr class="even pointer">
                                    <td class=" "><img src="{{asset('images/service/'.$data->image)}}" class="img_td" alt=""></td>
                                    <td class=" ">{{$data->title}}</td>
                                    <td class=" ">{{$data->description}}</td>
                                    <td class="a-right a-right"><a href="{{route('service.edit',$data->id)}}" class="btn btn-success">Edit</a></td>
                                    <td class=" last">
